...
COPY scripts/materialize-model.ts scripts/build-semantic-index.ts ./scripts/
COPY src ./src
...
COPY --from=retrieval-assets --chown=65532:65532 /app/models ./models
...
ENV LEARNED_SEMANTIC_ENABLED=false
EXPOSE 8080
